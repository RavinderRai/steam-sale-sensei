        ...
        if query_results_dct:
            ...
            if st.button("Predict how long until sale"):
                ...
                if discount_on_release < 0.5:
                    st.write('Will be on sale within the first 2 days')
                else:
                    ...
                    if months_until_sale == 1:
                        st.write(f"The game will go in sale in {months_until_sale} month.")
                    else:
                        st.write(f"The game will go in sale in {months_until_sale} months.")
